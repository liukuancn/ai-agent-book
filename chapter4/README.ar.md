...
| 4-2 | [أدوات التنفيذ](execution-tools/) | ✅ | تنفيذ مجموعة من أدوات التنفيذ مع آليات السلامة، بما في ذلك عمليات الملفات، ومترجم الشفرة، والمحطة الافتراضية، وتكامل النظام الخارجي. منع العمليات الخطيرة من خلال آلية الموافقة الثانوية LLM، وتلخيص المخرجات المعقدة تلقائيًا، وإجراء التحقق من صحة بناء الجملة على الشفرة. |
