...
> قم بطبق الفرضيات والتحقق من صحتها على مراحل: تشغيل فرضيات سطحية رخيصة (H1/H2، المستوى الفوري) بالتوازي أولاً، وإطلاق فرضيات عميقة باهظة الثمن بشكل مشروط (H5/H6، مقايضات النماذج). إحصائيًا: استخدم أولاً الأخطاء المعيارية كغربال محافظ لاستبعاد الاختلافات البعيدة المنال؛ وفي نفس مجموعة المهام، استخدم التحليل المزدوج (McNemar)، وهو أكثر حساسية بكثير من المقارنة المستقلة؛ لا تقرر متى يكون الفرق أصغر من عرض النطاق الترددي للضوضاء. عندما لا تتمكن مجموعة التقييم من حل الكسب المتوقع، حاول توسيعه.

**7. (★) في الحالة الافتراضية في هذا الفصل، أدى التفكير التمكيني عالميًا (H4) إلى تحسين معدل النجاح الإجمالي ولكن تم رفضه بسبب الكمون والتكلفة، وتطور في النهاية إلى التمكين المشروط (H7). ما هي الإشارات (ميزات وصف المهمة، وأنماط الفشل التاريخية، وعدم اليقين في وقت التشغيل) المناسبة كمعايير توجيه "لتمكين وضع التفكير"؟ هل توجد سيناريوهات للعملاء حيث يكون التفكير ضارًا بالفعل؟**

> إشارات التوجيه: أوصاف المهام التي تحتوي على ميزات العد/الاستدلال المعقد (يستخدم H7 LLM السريع الذي يستغرق من 1 إلى 2 ثانية للحكم المسبق)؛ أنواع المهام حيث تتجمع حالات الفشل التاريخية في مصفوفة علامة القدرة؛ إشارات عدم اليقين في وقت التشغيل مثل زيادة التراجعات أو أخطاء الأداة المتتالية. السيناريوهات الضارة: التفاعل في الوقت الفعلي الحساس لزمن الوصول (الصوت، تشغيل واجهة المستخدم)؛ بالنسبة للمهام البسيطة، فإن زيادة التكلفة بمقدار 3-5 مرات تعتبر إهدارًا خالصًا.
